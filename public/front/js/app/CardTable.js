...
class CardTable {
    constructor(containerId, options = {}) {
        ...
        this.options = {
            ...
            cardWrapper: options.cardWrapper || '<div class="card rounded-7" style="margin: .5rem .1rem;"><div class="card-body p-3">:content</div></div>',
    ...
    async init() {
        ...
        this.cardsContainer.className = 'cardtable-wrapper';
