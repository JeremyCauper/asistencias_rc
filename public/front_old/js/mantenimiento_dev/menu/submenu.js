$(document).ready(function () {
    configControls([
        { control: '#menu', requested: true },
        { control: '#categoria', mxl: 50 },
...
const url_base = `${__url}/mantenimiento-dev/menu/sub-menu`;
mostrar_acciones(tb_submenu);

// ======================================================
// GUARDAR / ACTUALIZAR
// ======================================================
$('#form-sub-menu').on('submit', async function (event) {
