...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <div>
                <button class="btn btn-primary" data-mdb-ripple-init data-mdb-modal-init data-mdb-target="#modal_tipo_personal">
...
<!-- Modal -->
<div class="modal fade" id="modal_tipo_personal" tabindex="-1" aria-labelledby="modal_tipo_personalLabel" aria-hidden="true">
...
<script src="{{secure_asset('front/js/mantenimiento_dev/tipopersonal/tipopersonal.js')}}"></script>
@endsection