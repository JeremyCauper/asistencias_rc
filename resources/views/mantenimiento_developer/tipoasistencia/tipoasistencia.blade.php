...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <div>
                <button class="btn btn-primary" data-mdb-ripple-init data-mdb-modal-init data-mdb-target="#modal_tipo_asistencia">
...
<!-- Modal -->
<div class="modal fade" id="modal_tipo_asistencia" tabindex="-1" aria-labelledby="modal_tipo_asistenciaLabel" aria-hidden="true">
...
<script src="{{secure_asset('front/js/mantenimiento_dev/tipoasistencia/tipoasistencia.js')}}"></script>
@endsection