...
@section('cabecera')
    <script src="{{ secure_asset('front/vendor/multiselect/bootstrap.bundle.min.js') }}?v=6.83.0.6"></script>
    <script src="{{ secure_asset('front/vendor/multiselect/bootstrap_multiselect.js') }}?v=6.83.0.6"></script>
    <script src="{{ secure_asset('front/vendor/multiselect/form_multiselect.js') }}?v=6.83.0.6"></script>
    <script>
...
@section('scripts')
    <script></script>
    <script src="{{ secure_asset('front/js/mantenimiento_dev/tipoasistencia/tipoasistencia.js') }}?v=6.83.0.6"></script>
@endsection
