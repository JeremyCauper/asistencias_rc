...
<script>
    ...
    const logoExcelLeyenda = '<?= $logoExcelLeyenda ?>';
</script>
<style>
...
<div class="dropdown me-2">
    <a
        ...
        role="button" aria-expanded="false" data-mdb-ripple-init>
        <span>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mb-2">
            <div class="col-xxl-4 col-7 my-1">
                <small class="form-label mb-0" for="empresas">Empresa</small>
            ...
            <div class="col-xxl-3 col-5 my-1">
                <small class="form-label mb-0" for="tipoPersonal">Modalidad</small>
            ...
            <div class="col-xxl-3 col-7 my-1">
                <small class="form-label mb-0" for="tipoModalidad">Tipo Personal</small>
            ...
            <div class="col-xxl-2 col-5 my-1">
        ...
        <script>
            const tablaAsistencias = new DataTable('#tablaAsistencias', {
                ...
                ajax: {
                    url: __url + `/asistencias/listarAsistencias?fecha=${$('#filtro_fecha').val()}&tipoModalidad=${$('#tipoModalidad').val()}&tipoPersonal=${$('#tipoPersonal').val()}`,
                    dataSrc: function(json) {
                        cargarNotificaciones(json)
                ...
                columns: [{
                    ...
                    },
                    {
                        data: 'tipo_personal',
                        render: function(data, type, row) {
                            let tpersonal = tipoPersonal[data];
            ...
            function filtroBusqueda() {
                ...
                var nuevoUrl = `${__url}/asistencias/listarAsistencias?fecha=${filtroFecha}&empresas=${empresa}&tipoModalidad=${tModalidad}&tipoPersonal=${tPersonal}`;
        ...
        <form class="modal-content" id="form-descuento">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex justify-content-between align-items-center my-2">
                    <h6 class="fw-semibold text-primary text-uppercase m-0" style="font-size: smaller;">Ingresar Descuento</h6>
                ...
                <!-- Monto del descuento -->
                <div class="mb-3">
                    <input type="number" step="0.01" min="0" class="form-control" id="monto_descuento" name="monto_descuento" placeholder="Monto del descuento">
                </div>

                <!-- Comentario -->
                <div class="mb-3">
                    <textarea class="form-control" id="comentario" name="comentario" rows="4" placeholder="Comentario (opcional)..."></textarea>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content" id="form-justificacion">
            <div class="modal-header bg-primary text-white">
                ...
                <button type="button" class="btn-close text-white" data-mdb-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="my-2" id="responderJustificacion">
                    ...
                    <div class="text-end">
                        <button class="btn btn-sm btn-success me-2" id="btnAprobar"><i class="fas fa-check"></i> Aprobar</button>
                        <button class="btn btn-sm btn-danger" id="btnRechazar"><i class="fas fa-times"></i> Rechazar</button>
                    </div>
                </div>
            </div>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-12 py-1">
                        <div class="btn-group" role="group">
                            <button id="btnMensual" class="btn btn-outline-primary active" data-mdb-ripple-init>Mensual</button>
