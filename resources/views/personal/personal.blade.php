...
<div class="card">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex align-items-center">
                <button class="btn btn-primary me-2" data-mdb-ripple-init data-mdb-modal-init data-mdb-target="#modalPersonal">
                    ...
                    <script>
                        [
                            ...
                            tipoModalidad.forEach(job => {
                                ...
                                estilos.append(`.${clase}:checked{border-color: ${color};}.${clase}[type=radio]:checked:after{background-color: ${color};}`);
                            });
