...
@section('content')
            ...
            <div class="card-body px-3">
                ...
                <div>
                    <button class="btn btn-primary" data-mdb-ripple-init data-mdb-modal-init
                        data-mdb-target="#modal_area_personal">
    ...
    <!-- Modal -->
    <div class="modal fade" id="modal_area_personal" tabindex="-1" aria-labelledby="modal_area_personalLabel"
        aria-hidden="true">
...
@section('scripts')
    <script></script>
    <script
        src="{{ secure_asset('front/js/mantenimiento/areapersonal/areapersonal.js') }}?v={{ config('app.version') }}"></script>
@endsection