@extends('layout.app')
@section('title', 'Areas del Personal')
...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <div>
                <button class="btn btn-primary" data-mdb-ripple-init data-mdb-modal-init data-mdb-target="#modal_area_personal">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <script>
                        const tb_area_personal = new DataTable('#tb_area_personal', {
                            autoWidth: true,
                            scrollX: true,
                            scrollY: 400,
...
<!-- Modal -->
<div class="modal fade" id="modal_area_personal" tabindex="-1" aria-labelledby="modal_area_personalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form class="modal-content" id="form-area-personal">
            <div class="modal-header  bg-primary text-white">
                <h6 class="modal-title" id="modal_area_personalLabel">REGISTRAR TIPO PERSONAL</h6>
...
<script src="{{secure_asset('front/js/mantenimiento/areapersonal/areapersonal.js')}}"></script>
@endsection