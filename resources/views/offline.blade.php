...
<body style="font-family: 'Segoe UI', Tahoma, sans-serif;font-size:75%;">
    ...
    <script>
        var loadTimeDataRaw = {
            ...
            "textdirection": "ltr",
            "title": "localhost",
            "web_app_error_page_message": "No tienes conexión"
        };
    </script>
</body>
